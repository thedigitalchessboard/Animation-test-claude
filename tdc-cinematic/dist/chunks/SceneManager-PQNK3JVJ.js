...
void main(){
  ...
  <g data-part="body">
    ...
    <g data-part="emblem" transform="translate(0 -84)">
      ...
      <path d="${G.knight}" transform="scale(.19) translate(-50 -66)" fill="${n}"/>
    </g>
