...
A silent, 14-second animated story that runs in real time (Three.js + GSAP + SVG) on the TDC homepage, between the hero section and *"Trusted by Parents. Loved by Students."*
